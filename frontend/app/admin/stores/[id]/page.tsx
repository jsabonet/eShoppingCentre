              ...
              <div className="bg-white rounded-lg border border-border p-5 shadow-sm">
                ...
                {store.identity_document || store.tax_document || store.address_proof || store.additional_documents ? (
                  <div className="space-y-2">
                    {store.identity_document && <a href={mediaUrl(store.identity_document) || '#'} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 p-2 bg-muted/20 rounded-lg hover:bg-muted/40 text-sm"><FileText size={16} className="text-blue-500" /> Documento de Identidade</a>}
                    {store.tax_document && <a href={mediaUrl(store.tax_document) || '#'} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 p-2 bg-muted/20 rounded-lg hover:bg-muted/40 text-sm"><FileText size={16} className="text-green-500" /> Comprovativo Fiscal</a>}
                    {store.address_proof && <a href={mediaUrl(store.address_proof) || '#'} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 p-2 bg-muted/20 rounded-lg hover:bg-muted/40 text-sm"><FileText size={16} className="text-orange-500" /> Comprovativo de Morada</a>}
